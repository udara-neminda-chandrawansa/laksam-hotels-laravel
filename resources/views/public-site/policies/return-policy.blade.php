    ...
    <div class="breadcumb-wrapper" data-bg-src="assets/img/drive-images-2-webp/kc5.jpg">
        ...
        <div class="container" style="position: relative; z-index: 10;">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Return & Refund Policy</h1>
                ...
                <div class="col-12">
                    <div class="about-content">
                        <div class="section-title">
                            <h2 class="wow fadeInUp" data-wow-delay=".3s">Our Cancellation, Return & Refund Policy</h2>
                        </div>
                        ...
                        <h4 class="mt-4 wow fadeInUp" data-wow-delay=".5s">1. Reservation Cancellations</h4>
                        <p class="wow fadeInUp" data-wow-delay=".6s">
                            Guests may cancel their reservations under the following conditions:
                        </p>
                        <ul class="wow fadeInUp" data-wow-delay=".6s">
                            <li>Cancellations made <strong>7 days or more</strong> prior to the check-in date will receive a full refund.</li>
                            <li>Cancellations made within <strong>3–6 days</strong> prior to check-in will incur a <strong>50% cancellation fee</strong>.</li>
                            <li>Cancellations made within <strong>48 hours</strong> of check-in or no-shows will be charged the <strong>full amount</strong>.</li>
                        </ul>

                        <p class="wow fadeInUp" data-wow-delay=".7s">
                            Please note that cancellation timelines may vary for promotional or third-party bookings. Always review the cancellation terms displayed during booking.
                        </p>
                        ...
                        <p class="wow fadeInUp" data-wow-delay="1.4s">
                            For bank transfers or manual payments, please provide your bank account details for the refund to be issued securely.
                        </p>
                        ...
                        <h4 class="mt-4 wow fadeInUp" data-wow-delay="1.9s">7. Contact Us</h4>
                        <p class="wow fadeInUp" data-wow-delay="2s">
                            For all cancellation or refund inquiries, please contact our reservations team:
                        </p>
