            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('tour-packages.store') }}" method="POST" id="tourPackageForm" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select name="price_unit" id="price_unit" class="form-select"
                                                        required>
                                                        <option value="per pax" {{ old('price_unit')=='per pax'
                                                            ? 'selected' : '' }}>per pax</option>
                                                        <option value="per group" {{ old('price_unit')=='per group'
                                                            ? 'selected' : '' }}>per group</option>
                                                        <option value="per hour" {{ old('price_unit')=='per hour'
                                                            ? 'selected' : '' }}>per hour</option>
                                                        <option value="per day" {{ old('price_unit')=='per day'
                                                            ? 'selected' : '' }}>per day</option>
                                                        <option value="per activity" {{
                                                            old('price_unit')=='per activity' ? 'selected' : '' }}>per
                                                            activity</option>
                                                    </select>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="difficulty_level" id="difficulty_level"
                                                        ...
                                                        <option value="easy" {{ old('difficulty_level')=='easy'
                                                            ? 'selected' : '' }}>Easy</option>
                                                        <option value="moderate" {{ old('difficulty_level')=='moderate'
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="min_participants" id="min_participants"
                                                        ...
                                                        @for($i = 1; $i <= 10; $i++) <option value="{{ $i }}" {{
                                                            old('min_participants', 1)==$i ? 'selected' : '' }}>{{ $i }}
                                                            </option>
                                                            @endfor
                                                    </select>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="max_participants" id="max_participants"
                                                        ...
                                                        @for($i = 1; $i <= 20; $i++) <option value="{{ $i }}" {{
                                                            old('max_participants', 4)==$i ? 'selected' : '' }}>{{ $i }}
                                                            </option>
                                                            @endfor
                                                    </select>
                                        ...
                                        <div class="card-body">
                                            <div id="preview-card" class="border rounded p-3">
                                                <img id="preview-image"
                                                    src="{{ asset('assets/img/tours/helicopter1.jpg') }}"
                                                    alt="Tour Preview" class="img-fluid rounded mb-2"
                                                    style="height: 120px; object-fit: cover; width: 100%;">
                                                <h6 id="preview-name" class="mb-1">Package Name</h6>
                                                <p id="preview-subtitle" class="text-muted small mb-1">Subtitle</p>
                                                <p id="preview-price" class="text-success mb-1"><strong>Contact for
                                                        price</strong></p>
                                                <p id="preview-duration" class="mb-1"><small><i
                                                            class="fas fa-clock me-1"></i>Duration</small></p>
                                                <p id="preview-difficulty" class="mb-2"><small><span
                                                            class="badge badge-success">Easy</span></small></p>
                                                <p id="preview-description" class="text-muted small">Description will
                                                    appear here...</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-1"></i>Create Tour Package
                                        </button>
                                    </div>
                                </div>
                            </div>
